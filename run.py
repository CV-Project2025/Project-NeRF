...
def main():
    ...
    parser.add_argument('--image', type=str, default='data/fox.jpg')
    parser.add_argument('--config', type=str, default='configs/part1_fox.yaml', help='配置文件路径')
    ...
    # 数据加载
    coords, gt_rgb, H, W = get_2d_data(args.image)
    ...
    print(f">>> 配置: L={config['L_embed']}, Hidden={config['hidden_dim']}, Steps={epochs}")
    ...
    plt.imsave('output/result_part1.png', final_img)
